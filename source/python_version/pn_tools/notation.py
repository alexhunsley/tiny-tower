...
# from pn_tools import method_generation

# from . import defs
# from . import helpers
# from . import encode_decode
# from . import pn_mirror
# from . import pn_canonical
# from . import pn_rotation
# from . import enumerating
# from . import method_generation
# from . import encode_decode

# from pn_tools import method_generation
# from pn_tools.enumerating import all_possible_notation_ranged
from pn_tools.enumerating import *
from pn_tools.method_generation import iter_notate_combos_no_rotations
from pn_tools.encode_decode import *
# from pn_tools.encode_decode import collapse_place_notation
# from pn_tools.encode_decode import expand_rotation_notation_to_palindrome_string_list
from pn_tools.helpers import *
from pn_tools.pn_rotation import canonical_form, rotation_as_string_list, all_rotations, are_rotation_of_each_other

def main():
    print("FUCKING BULLSJIT PYTHON CRAP")

    mod = sys.modules[__name__]          # 'pn_tools.notation'
...
class TestNotationCanonical(unittest.TestCase):
    ...
    def test_apply_and_generate(self):
        from pn_tools.method_generation import apply_token_to_row
        from pn_tools.method_generation import generate_rows
